...
class Exception extends \Exception {
    ...
    const TREECONSTRUCTOR_FORMELEMENT_EXPECTED = 601;
    const TREECONSTRUCTOR_DOCUMENTFRAG_ELEMENT_DOCUMENT_DOCUMENTFRAG_EXPECTED = 602;
    const TREECONSTRUCTOR_UNEXPECTED_END_OF_FILE = 603;
    const TREECONSTRUCTOR_NON_EMPTY_TARGET_DOCUMENT = 604;
    const TREECONSTRUCTOR_INVALID_TOKEN_CLASS = 605;
    const TREECONSTRUCTOR_INVALID_INSERTION_LOCATION = 606;
